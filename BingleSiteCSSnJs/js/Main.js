...
pw=!1;let pwd=!1;var commands=[];function enterKey(e){if(181==e.keyCode&&document.location.reload(!0),pw)
    ...
    ;case"members_portal":liner.classList.add("password"),pw=!0;break
    ;case"who_are_we":loopLines(projects,"color2 margin",80);break
    ...
    setTimeout((function(){loopLines(banner,"",80),textarea.focus()}),100),window.addEventListener("keyup",enterKey),console.log("%cYou hacked my password!😠","color: #04ff00; font-weight: bold; font-size: 24px;"),
