...
banner = [
  "<br>",
  '<span class="index">OOC: Please do not data mine this website <3</span>',
  ...
  //"<span class=\"color3\">╚═╝      ╚═════╝  ╚═════╝╚═╝  ╚═╝     ╚═════╝╚═╝╚═════╝ </span>",
  //"<span class=\"color3\">///--------------------------------------------------///</span>",
  //'  <img src="https://i.imgur.com/r4Y5D3f.png" width="540" hight="260">',
  "///------------Website Hosted in Zürich------------///",
  "///--------------------OTTP & FPE------------------///",
...
changelog = [
  ...
  "<span class='command'>                Updated Banner - 20/01/2024</span>",
...
joinus = [
  "<br>",
  "<span class=\"color3\">///---------------Aplication Status: CLOSED-----------------///</span>",
  "<span class=\"color3\">///--do you think you have what it takes to help bingle?--///</span>",
